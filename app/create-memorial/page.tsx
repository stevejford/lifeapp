...
export default function CreateMemorial() {
  ...
  const handleContinue = () => {
    console.log('Continuing with:', { givenName, familyName, dateOfBirth, dateOfPassing })
    ...
    <div className="flex min-h-screen bg-background">
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="text-center">
            <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Online Memorial</h2>
            <p className="mt-2 text-sm text-gray-600">
              Create a beautiful online memorial to celebrate your loved one's life. Please provide their:
            </p>
          </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-1"
                  value={dateOfPassing}
                  onChange={(e: ChangeEvent<HTMLInputElement>) => setDateOfPassing(e.target.value)}
                />
              </div>
              ...
              <div>
                <Button
                  ...
                  disabled={!givenName || !familyName || !dateOfBirth || !dateOfPassing}
                >
                  Continue
                </Button>
              </div>
      ...
      <div className="hidden lg:block relative w-0 flex-1">
        <Image
          ...
          src="/new-memorial-hands.jpg"
          alt="Online Memorial Cover"
          layout="fill"
        />
      </div>
    </div>
